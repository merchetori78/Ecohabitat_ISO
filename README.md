...
## 🔗 Configuración Google Sheets — ya preconfigurada

Esta versión ya incluye la conexión a la Google Sheet de EcoHabitat. Los encargados no tienen que introducir ni el ID de la hoja ni la URL del Web App.

- **Google Sheet ID:** `1IlgaOGnzS1lClFJ0wpVRwK-ZgDL-i_FDRopEozYKbvU`
- **Apps Script Web App:** preconfigurado en `index.html`
...
4. En esta versión ya no es necesario rellenar esos campos: vienen guardados en el código
5. Usa **Probar Conexión** para verificar que funciona
6. Usa **Sincronizar Ahora** para enviar todos los datos a Sheets
